package com.gary.adminweb.web;

import java.util.ArrayList;
import java.util.List;
import java.util.Optional;

import com.gary.adminweb.data.model.Customer;
import com.gary.adminweb.data.model.Order;
import com.gary.adminweb.data.repository.CustomerRepository;
import com.gary.adminweb.data.repository.OrderRepository;
